...
public class CritGlowEffect : MonoBehaviour
{
    ...
    public void EnableCrits()
    {
        ...
        if (!AudioManager.IsSoundPlaying(BattleSceneSounds.CritPower))
        {
            AudioManager.PlaySound(BattleSceneSounds.CritPower);
        }
    }
    ...
    public void DisableCrits()
    {
        ...
        AudioManager.StopSoundIfPlaying(BattleSceneSounds.CritPower, null, true);
    }
}