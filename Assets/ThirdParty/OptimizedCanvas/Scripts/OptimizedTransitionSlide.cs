...
public class OptimizedTransitionSlide : OptimizedTransitionBase
{
    ...
    [SerializeField] SlideStruct[] sliders = new SlideStruct[1];
    [SerializeField] Ease easeType = Ease.Linear;

    public override float GetTransitionInTime() => transitionTime;
    public override float GetTransitionOutTime() => transitionTime;
